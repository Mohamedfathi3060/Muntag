...
import {} from "./signupstyle.modules.css";
          ...
          <div className="col-md-6 d-flex justify-content-center align-items-center">
            <div className="form accountform w-50">
              ...
              <div className="errorscontainer bg-danger rounded-1 d-none">
                <ul className="errorslist"></ul>
              </div>
              <div className="inputcontainer my-4">
                <input
                  type="text"
                  className="form-control border-0 border-bottom inputfield empty"
                  id="name"
                  title="Enter Your Name"
                  placeholder=""
                  required
                />
                <label htmlFor="name" className="floatinglabel px-2">
                  Name
                </label>
              </div>
              <div className="inputcontainer my-4">
                <input
                  ...
                  required
                />
                <label htmlFor="identifier" className="floatinglabel px-2">
              ...
              <div className="inputcontainer my-4">
                <input
                  ...
                  required
                />
                <label htmlFor="password" className="floatinglabel px-2">
                  Password
                </label>
              </div>
              <div className="inputcontainer mt-4">
                <input
                  ...
                  required
                />
                <label htmlFor="confirmPassword" className="floatinglabel px-2">
                  Confirm Password
                </label>
              </div>
              <button
                type="submit"
                className="btn btn-danger w-100 px-2 py-3 mt-4 mb-2 fw-bold createAccountBtn"
              >
                Create Account
              </button>
              <div className="googlesignup">
                <button
                  type="submit"
                  className="btn btn-outline-success outlinehover text-black w-100 px-2 py-3 fw-bold"
                >
                  Sign Up with Google
                </button>
              ...
              <div className="d-flex w-100 justify-content-center my-3">
                <p className="text-secondary d-inline-block me-2">
                  already have account?
                </p>
                <Link
                  to="/login"
                  className="link-dark text-decoration-underline fw-bold loginlink"
                >
                  login
                </Link>
              </div>
