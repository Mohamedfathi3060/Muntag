          ...
          <div className="row w-100 justify-content-between">
            <div className="col-md-10">
              <div className="d-flex w-100 h-100 justify-content-center align-items-center">
                ...
                <Link
                  to=""
                  className="text-decoration-underline text-white fw-bold ms-2"
                >
                  Shop Now
                </Link>
              </div>
            ...
            <div className="col-md-6 d-md-block d-flex col-6">
              <div className="d-flex justify-content-center">
                <ul className="nav col-12 col-md-auto d-flex mb-2 justify-content-center mb-md-0">
                  <li>
                    <NavLink to="" className="nav-link px-4 fw-bold link">
                      Home
                    </NavLink>
                  </li>
                  <li>
                    <NavLink
                      to="contact"
                      className="nav-link px-4 fw-bold link"
                    >
                      Contact
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="about" className="nav-link px-4 fw-bold link">
                      About
                    </NavLink>
                  </li>
                  <li>
                    <NavLink to="signup" className="nav-link px-4 fw-bold link">
                      Signup
                    </NavLink>
                  </li>
                </ul>
